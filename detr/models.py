...
def detect(im, model, transform):
    ...
    print(outputs['pred_boxes'][0, keep], outputs['pred_boxes'][0][keep].shape)
...
if __name__ == '__main__':
    ...
    #     map_location='cpu',
    #     check_hash=True)
    state_dict = torch.load("/Users/gene/project/tools/llm_tools/detr/weights/detr_demo-da2a99e9.pth", map_location="cpu")
    ...
    # im = Image.open('/Users/gene/Documents/photo/lws/IMG_8137.jpeg').convert('RGB')
    # scores, boxes = detect(im, detr, transform)
    # plot_results(im, scores, boxes)
    import torchvision
    conv1 = nn.Conv2d(3, 2*3*3, 3, padding=1)
    def_conv1 = torchvision.ops.DeformConv2d(in_channels=3, out_channels=64, kernel_size=3, padding=1)
    input_img = torch.rand(1, 3, 224, 224)
    out = conv1(input_img)
    print()
    out = def_conv1(input_img, out)
    print(out)