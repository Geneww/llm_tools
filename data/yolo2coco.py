...
parser.add_argument('--root_dir', default='/home/gene/disk/hdd1/datasets/fire_smoke/1train_datasets/1_newest_train_datasets/newest_datasets',type=str, help="root path of images and labels, include ./images and ./labels and classes.txt")
