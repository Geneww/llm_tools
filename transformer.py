...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, input_Q, input_K, input_V, attn_mask):
        ...
        return nn.LayerNorm(d_model)(output + residual)  # output: [batch_size, len_q, d_model]
...
class Encoder(nn.Module):
    ...
    def forward(self, enc_inputs):
        ...
        print("enc_outputs: ", enc_outputs, enc_outputs.shape)
...
#
# in_emb = nn.Embedding(src_vocab_size, d_model)
# out_emb = nn.Embedding(tgt_vocab_size, d_model)
#
# pe = PositionalEncoding(d_model)
#
# for enc_inputs, dec_inputs, dec_outputs in loader:
#     in_embedding = in_emb(enc_inputs)
#     out_embedding = out_emb(dec_inputs)
#     print(in_embedding, in_embedding.shape)
#     # print(out_embedding, out_embedding.shape)
#     in_embedding = pe(in_embedding)
#     print(in_embedding, in_embedding.shape)
#
#     in_embedding = pe(in_embedding)
#     print(in_embedding, in_embedding.shape)
